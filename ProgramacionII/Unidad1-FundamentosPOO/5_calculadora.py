...
class Calculadora:
    ...
    def ingreso_de_datos(self):
        while (True):
            ...
            # Cuando se sale del programa con el atajo de tecaldo (ctrl + c / ctrl + d)
            except EOFError:
    ...
    def convertir_a_entero():
        ...
        numero_convertido = trunc(primer_numero)
        # Redondeando al entero mas cercano
        numero_truncado = ceil(primer_numero)
    ...
    def menu(self):
        while (True):
            ...
            try:
                # Se almacena el valor ingresado
                opcion_seleccionada = (input("> "))
                # Dependiendo del valor ingresado se llama al metodo
                # match-case para manejar multiples condiciones.
